...
import { issueSolutions } from "../interfaces/IssueDoc";
import { userSolutions } from "../interfaces/IUser";
...
router.get("/snippet/:IssueID", async (req: INamedRequest, res, next) => {
   const { UniqueUsername, Email } = req.thisUser as reqUser;
   const _id = req.params.IssueID;
...
router.put("/bookmark", async (req: INamedRequest, res, next) => {
...
router.put("/bookmark/remove", async (req: INamedRequest, res, next) => {
...
router.put("/close", async (req: INamedRequest, res, next) => {
   const { UniqueUsername } = req.thisUser as reqUser;
...
router.put("/reopen", async (req: INamedRequest, res, next) => {
   let { UniqueUsername } = req.thisUser as reqUser;
...
router.delete("/delete", async (req: INamedRequest, res, next) => {
   let { UniqueUsername } = req.thisUser as reqUser;
...
router.post(
   "/solution/add-like",
   async (req: INamedRequest, res, next) => {
      let { UniqueUsername } = req.thisUser as reqUser;
...
router.post("/solution/remove-like", async (req: INamedRequest, res, next) => {
   const { UniqueUsername } = req.thisUser as reqUser;
